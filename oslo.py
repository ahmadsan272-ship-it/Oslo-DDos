...
def attack(ip: str, port: int, packet_size: int, rate_limit: float):
    ...
    try:
        while True:
            ...
            sent += 1
            log_message(f"\033[38;5;37m• • Server-Ip \033[37m|\033[32m {ip} \033[37m| \033[38;5;242mPort: \033[37m{port}")
...
time.sleep(10)
print("\033[36m  HARI GINI JADI TERMUL, LAPAR LO YE...!! 🤣🤣 \033[0m")
time.sleep(5)
print("\033[37m  HARI GINI JADI TERMUL, LAPAR LO YE...!! 🤣🤣 \033[0m")
time.sleep(5)
print("Loading.......")
